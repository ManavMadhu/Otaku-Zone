...
function Home() {
  ...
  let charSliderElement = createRef();
  ...
  useEffect(() => {
    ...
    search.searchTopChar().then((data) =>{
      search.setTopChar(data.data);
  ...
  return (
    <div className="home-background">
      <Card className="bg-dark text-white">
        <Card.Img
          src={
            "https://initiate.alphacoders.com/images/807/cropped-845-270-807240.png?5164"
          }
          alt="Card image"
        />
      </Card>
      ...
      <Container fluid className="padding-top-style">
        ...
        <Row className="padding-top-style">
          <Col lg={2}>
            <h2 className="home-header-top-text">Top Characters</h2>
          </Col>
          <Col lg={9}>
            <hr className="horizontal-line-top-homepage" />
          </Col>
          <Col lg={1}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
              onClick={() => charSliderElement.slidePrev()}
              style={{ width: "30px" }}
              className="slider-arrow-btn"
            >
              <path
            ...
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512"
              onClick={() => charSliderElement.slideNext()}
              style={{ width: "30px" }}
              className="slider-arrow-btn"
            >
              <path
        ...
        <Row>
          <Carousel
            ...
            showArrows={false}
            transitionMs={800}
            ref={(ref) => (charSliderElement = ref)}
          >
            {search.topCharData.map((anime) => {
              return <CharCard key={anime.mal_id} anime={anime} />;
            })}
          </Carousel>
        </Row>
      </Container>
